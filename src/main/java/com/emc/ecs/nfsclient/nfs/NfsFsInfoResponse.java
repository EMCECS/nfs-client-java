 ...
 * @author seibed
 */
public class NfsFsInfoResponse extends NfsResponseBase {

    /**
     * The returned information.
     */
    private NfsFsInfo _fsInfo;
     ...
     *            other versions.
     */
    public NfsFsInfoResponse(int nfsVersion) {
        super();
    }
    ...
    public void unmarshalling(Xdr xdr) throws RpcException {
        ...
        if (stateIsOk()) {
            _fsInfo = new NfsFsInfo(xdr);
        }
    }

    /**
     * @return the nonvolatile file system state information and
     * general information about the NFS version 3 protocol server
     * implementation
     */
    public NfsFsInfo getFsInfo() {
        return _fsInfo;
    }
