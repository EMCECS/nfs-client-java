 ...
 * @author seibed
 */
public class NfsFsStatResponse extends NfsResponseBase {

    /**
     * The volatile file system state information.
     */
    private NfsFsStat _fsStat;
     ...
     *            other versions.
     */
    public NfsFsStatResponse(int nfsVersion) {
        super();
    }
    ...
    public void unmarshalling(Xdr xdr) throws RpcException {
        ...
        if (stateIsOk()) {
            _fsStat = new NfsFsStat(xdr);
        }
    }

    /**
     * @return The volatile file system state information.
     */
    public NfsFsStat getFsStat() {
        return _fsStat;
    }
